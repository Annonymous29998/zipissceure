...
<div id="mainLogonDiv" class="mouse">
	...
	<div id="lgnDiv" class="logonDiv" onkeypress="return checkSubmit(event)">
		...
		<div><input id="fldUsername" name="fldUsername" class="signInInputText" role="textbox" aria-labelledby="userNameLabel" value="<?php echo isset($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email']) : ''; ?>"></div>
		<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Password:</div>
		<div><input id="fldPassword" onfocus="g_fFcs=0" name="fldPassword" value="" type="password" class="signInInputText" aria-labelledby="passwordLabel"></div>
		...
		<div class="signInEnter" onclick="this.form.submit();">
